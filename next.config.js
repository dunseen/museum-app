...
const CSP_SOURCES = {
  ...
  img: [
    ...
    'data:',
    'blob:',
    'https://museum.dlima-consulting.com',
...
const config = {
  ...
  typescript: {
    ignoreBuildErrors: !!process.env.SKIP_NEXT_CHECKS,
  },
  eslint: {
    ignoreDuringBuilds: !!process.env.SKIP_NEXT_CHECKS,
  },
  basePath: '/app',
  async headers() {
    return [
    ...
    remotePatterns: [
      {
        ...
        hostname:
          process.env.NODE_ENV === 'production'
            ? 'museum.dlima-consulting.com'
            : 'localhost',
        pathname: process.env.NODE_ENV === 'production' ? '/storage/**' : '/',
      },
    ],
  },
};
