    ...
    <AccordionItem value="specialists">
      ...
      <AccordionContent>
        <div className="grid grid-cols-2 gap-4">
          <FieldDiff
            label="Coletor"
            oldValue={getOldValueFromDiff(diff, "collector", collector, isUpdate)}
            newValue={collector}
          ...
          <FieldDiff
            label="Determinador"
            oldValue={getOldValueFromDiff(diff, "determinator", determinator, isUpdate)}
          ...
          <FieldDiff
            ...
            oldValue={getOldValueFromDiff(diff, "collectedAt", collectedAt, isUpdate)}
